...
from .serializers import AboutMeSerializer, MyEducationSerializer, StackSerializer, FeedbackSerializer, \
    ...
    CardProjectSerializer, TodoDeletePutSerializer
...
@swagger_auto_schema(method='PUT', request_body=TodoDeletePutSerializer, **schema_todo_put())
@api_view(['PUT'])
def todo_change_status_api(request, **kwargs):
    """
    Change status to-do
    ...
    serializer = TodoDeletePutSerializer(data=request.data, context={'day': day})
...
@swagger_auto_schema(method='DELETE',request_body=TodoDeletePutSerializer, **schema_todo_delete())
@api_view(['DELETE'])
